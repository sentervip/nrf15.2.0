...
#define DEVICE_NAME                     "HTS"                                /**< Name of device. Will be included in the advertising data. */
...
#define APP_ADV_INTERVAL                2000//40                                          /**< The advertising interval (in units of 0.625 ms. This value corresponds to 25 ms). */
...
{
    static ble_date_time_t time_stamp = { 2019, 5, 15, 11, 50, 0 };

    uint32_t celciusX100;

    time_stamp.year = g_HtValue;
